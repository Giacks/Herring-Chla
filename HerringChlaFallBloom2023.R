...
ggplot(maxnweekyears, aes(x = Year, y = nweek_maxchlfall)) +
  ...
  theme_classic()
ggsave(filename="PlotNweekChlFallBloom.png", bg="white", height=4, width = 5, dpi=500)
#write.csv(maxnweekyears, "WeekNumberChlMax.csv", row.names=FALSE)
#write.csv(pehn1, "chldatanwek.csv", row.names=FALSE)
